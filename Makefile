...
phpunit:
	docker-compose exec --rm app sh -c 'cd /var/www/html ; ./vendor/bin/phpunit; (exit $?)'

phpunit-coverage-html:
	docker-compose exec --rm app sh -c 'cd /var/www/html ; ./vendor/bin/phpunit --coverage-html ./coverage/; (exit $?)'

phpunit-coverage-clover:
	docker-compose exec --rm app sh -c 'cd /var/www/html ; ./vendor/bin/phpunit --coverage-clover ./coverage/coverage.xml; (exit $?)'
